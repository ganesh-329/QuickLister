...
import { AdminStats, RecentActivity } from '../../../shared/types/index.js';
  ...
  try {
    ...
    const recentActivity: RecentActivity[] = [
      ...
      ...recentGigs.map(gig => ({
        ...
        userName: (gig.posterId as any)?.name
      }))
...
export const deleteUser = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    await Gig.updateMany(
      ...
      { $pull: { applications: { applicantId: userId } } }
    );
...
export const getGigs = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    const formattedGigs = gigs.map(gig => ({
      ...
      posterName: (gig.posterId as any)?.name || 'Deleted User'
    }));
...
// Update gig status
export const updateGigStatus = async (req: Request, res: Response): Promise<void> => {
  try {
