...
import { createGig, getGigs, getGigById, updateGig, deleteGig, applyToGig, acceptApplication, rejectApplication, getUserPostedGigs, getUserApplications } from '../controllers/gigController.js';
