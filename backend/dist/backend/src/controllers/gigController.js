...
export const getGigs = async (req, res) => {
    try {
        ...
        if (search && lat && lng) {
            ...
            gigs = gigs.filter(gig => gig.title.toLowerCase().includes(searchLower) ||
...
export const acceptApplication = async (req, res) => {
    try {
        ...
        const rejectedApplications = gig.applications.filter((app) => app._id.toString() !== applicationId && app.status === 'pending');
