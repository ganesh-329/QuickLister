...
const GigLocationSchema = new Schema({
    type: {
        type: String,
        enum: ['Point'],
        required: true,
...
GigSchema.methods.addApplication = function (applicationData) {
    ...
    const existingApplication = this.applications.find((app) => app.applicantId.toString() === applicationData.applicantId?.toString());
...
GigSchema.methods.acceptApplication = function (applicationId, applicantId) {
...
// Static Methods
GigSchema.statics.findNearby = function (coordinates, radiusKm = 15, filters = {}) {
    return this.find({
...
GigSchema.statics.findBySkills = function (skills, coordinates, radiusKm = 15) {
    const query = {
...
GigSchema.statics.searchGigs = function (searchTerm, coordinates, radiusKm = 15) {
    const query = {
