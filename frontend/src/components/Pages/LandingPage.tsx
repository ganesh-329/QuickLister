    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="w-full px-8 py-4 border-b border-gray-100">
        <div className="flex items-center">
          <img src="/images/logo.svg" alt="QuickLister Logo" className="h-10 w-10" />
          ...
          <div className="max-w-lg">
            ...
            <div className="text-center mb-12">
              <div className="flex flex-col items-center mb-8">
                <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-3">
                  Welcome to QuickLister
                </h1>
                <p className="text-xl text-blue-600 font-medium mb-6">
                  List. Connect. Earn. Repeat.
                </p>
              </div>
            ...
            <div className="grid grid-cols-2 gap-6 mt-16">
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold text-gray-900 mb-1">Smart Gig Management</h3>
